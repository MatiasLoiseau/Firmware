...
/* If configSUPPORT_STATIC_ALLOCATION is set to 1 then RTOS objects
 *  can be created using RAM provided by the application writer.
 *  If undefined it defaults to 0 */
#define configSUPPORT_STATIC_ALLOCATION         0
/* If configSUPPORT_DYNAMIC_ALLOCATION is set to 1 then RTOS objects
 * can be created using RAM that is automatically allocated from the FreeRTOS heap.
 * If undefined it defaults to 1 */
...
#else
#if defined(CORE_M0PLUS)
#error npi que va aca para el xPortSysTickHandler
#else
#if defined(CORE_M0)
